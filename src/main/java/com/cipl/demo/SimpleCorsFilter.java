 ...
 * @Component
 * 
 * @Order(Ordered.HIGHEST_PRECEDENCE) public class SimpleCorsFilter implements
 * Filter {
 * 
 ...
 * response = (HttpServletResponse) res; HttpServletRequest request =
 * (HttpServletRequest) req; response.setHeader("Access-Control-Allow-Origin",
 ...
 * "x-requested-with, authorization, content-type,otp");
 * 
